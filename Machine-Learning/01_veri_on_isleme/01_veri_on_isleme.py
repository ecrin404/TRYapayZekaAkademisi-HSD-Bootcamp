...
Amaç:
    ...
    3. Kategorik verileri label encoding ve one-hot encoding ile dönüştür yani sayısal hale getir 
    4. Veriyi train, validasyon ve test kümelerine ayır
    5. Sayısal özelliklere standardization ve normalization uygula yani veriyi ölçeklendir
