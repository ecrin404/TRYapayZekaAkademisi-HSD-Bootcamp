...
dizi = np.arange(0, 31)
secim = dizi[10:21]
print("Diziden seçilen elemanlar:", secim)
...
birlesmis = np.append(a, b) # np.hstack((a, b))
print("İki dizinin birleşimi:", birlesmis)
...
dizi = np.arange(1, 13)
matris = dizi.reshape(3, 4) # np.reshape(dizi, (3, 4))
...
transpose = matris.transpose()

print("Matris:\n", matris)
print("Matrisin Transpose'u:\n", transpose)
